...
{
    public class BmsSystemparametersReceive
    {
        // 系统状态参数
        ...
        public ushort DIPSwitchValue { get; set; }           // 拨码开关值
        ...
        public ushort DcSourceVoltage { get; set; }          // DC源电压
        public ushort DcSourceCurrent { get; set; }          // DC源电流
        ...
        // 预留参数
        public ushort Reserved1 { get; set; }              // 预留1(电子负载输出状态)
